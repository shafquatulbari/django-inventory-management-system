...
SECRET_KEY = 'django-insecure-&oe!y%i2adj@3pi=tsn&h!cd@g__cnc66q^wxshfz@-svhc==c'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        'rest_framework.permissions.AllowAny',  # Allow unrestricted access unless specified
    ),
}
